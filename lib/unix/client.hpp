...
namespace unix
{
  ...
  inline client_t::client_t (asio::io_context &context,
                                         port_t::value_t port,
                                         const std::string &host,
                                         notify_t connected,
                                         notify_t written,
  ...
  inline void client_t::connect (bool force)
  {
  ...
  inline bool client_t::write (const request_t &request)
  {
