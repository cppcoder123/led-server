...
static uint8_t fill_matrix(uint8_t matrix[], uint8_t symbol_id)
{
  ...
  case FONT_L:
    {
      static const uint8_t symbol[] = {0x7F, 0x40, 0x40, 0x40, 0x40};
      needed_symbol = symbol;
      break;
    }
  case FONT_M:
  ...
  case FONT_N:
    {
      static const uint8_t symbol[] = {0x7F, 0x04, 0x08, 0x10, 0x7F};
      needed_symbol = symbol;
      break;
    }
  case FONT_O:
  ...
  case FONT_P:
    {
      static const uint8_t symbol[] = {0x7F, 0x09, 0x09, 0x09, 0x06};
      needed_symbol = symbol;
      break;
    }
  case FONT_R:
    {
      static const uint8_t symbol[] = {0x7F, 0x09, 0x19, 0x29, 0x46};
      needed_symbol = symbol;
      break;
    }
  case FONT_S:
    {
      static const uint8_t symbol[] = {0x46, 0x49, 0x49, 0x49, 0x31};
      needed_symbol = symbol;
      break;
    }
  case FONT_T:
  ...
  case FONT_d:
    {
      static const uint8_t symbol[] = {0x38, 0x44, 0x44, 0x48, 0x7F};
      needed_symbol = symbol;
      break;
    }
  case FONT_e:
  ...
  case FONT_p:
    {
      static const uint8_t symbol[] = {0x7C, 0x14, 0x14, 0x14, 0x08};
      needed_symbol = symbol;
      break;
    }
  case FONT_r:
  ...
  case FONT_t:
    {
      static const uint8_t symbol[] = {0x04, 0x3F, 0x44, 0x40, 0x20};
      needed_symbol = symbol;
      break;
    }
  case FONT_u:
    {
      static const uint8_t symbol[] = {0x3C, 0x40, 0x40, 0x20, 0x7C};
      needed_symbol = symbol;
      break;
    }
  case FONT_v:
    {
      static const uint8_t symbol[] = {0x1C, 0x20, 0x40, 0x20, 0x1C};
      needed_symbol = symbol;
      break;
    }
  case FONT_x:
    {
      static const uint8_t symbol[] = {0x44, 0x28, 0x10, 0x28, 0x44};
      needed_symbol = symbol;
      break;
    }
  case FONT_y:
    {
      static const uint8_t symbol[] = {0x0C, 0x50, 0x50, 0x50, 0x3C};
      needed_symbol = symbol;
      break;
    }
  case FONT_AT:
  ...
  case FONT_STAR:
    {
      static const uint8_t symbol[] = {0x08, 0x2A, 0x1C, 0x2A, 0x08};
      needed_symbol = symbol;
      break;
    }
  default:
...
uint8_t font_add_symbol(uint8_t symbol, struct buf_t *buf)
{
  ...
  for (uint8_t i = 0; i < SYMBOL_SIZE; ++i)
    if (buf_byte_fill (buf, matrix[i]) == 0)
      return 0;
